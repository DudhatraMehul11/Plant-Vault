<%@ Page Title="" Language="C#" MasterPageFile="~/Adminmaster.master" AutoEventWireup="true" CodeFile="manageProfile.aspx.cs" Inherits="manageProfile" %>
                ...
                <div class="contact-form">
                    ...
                    <div class="section group">
                        ...
                        <div class="col span_1_of_3">
                            ...
                            <span>
                                <asp:DropDownList runat="server" ID="ddlState" AutoPostBack="true" class="dropDownBox" OnSelectedIndexChanged="ddlState_SelectedIndexChanged">
                                </asp:DropDownList>
                            </span>
                        </div>
                        <div class="col span_1_of_3">
