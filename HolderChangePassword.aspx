<%@ Page Title="" Language="C#" MasterPageFile="~/Holder.master" AutoEventWireup="true" CodeFile="HolderChangePassword.aspx.cs" Inherits="HolderChangePassword" %>
                    ...
                    <div class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4 wow fadeInUp text-center" data-wow-delay="100ms">
                                ...
                                <span>
                                    <asp:TextBox ID="txtOldPassword" ToolTip="name" class="bigTextBox" runat="server"></asp:TextBox>
                            ...
                            <div>
                                ...
                                <span>
                                    ...
                                    <asp:TextBox ID="txtNewPassword" ToolTip="name" class="bigTextBox" runat="server"></asp:TextBox>
                            ...
                            <div>
                                ...
                                <span>
                                    ...
                                    <asp:TextBox ID="txtConformPassword" ToolTip="name" class="bigTextBox" runat="server"></asp:TextBox>
                            ...
                            <div>
                                <span>
                                    ...
                                    <asp:Button ID="btnChangePassword" runat="server" value="Submit" class="submitButton" Text="ChangePassword" OnClick="btnSave_Click" />
