<%@ Page Title="" Language="C#" MasterPageFile="~/homemaster.master" AutoEventWireup="true" CodeFile="ViewProductDetailPage.aspx.cs" Inherits="ViewProductDetailPage" %>
                ...
                <div class="cont-desc span_1_of_2">
                    <div class="product-details">
                        ...
                        <div class="desc span_3_of_2">
                            ...
                            <div>
                                <span>
                                    <asp:Button class="submitButton" ID="btnPlaceOrder" runat="server" Value="Place Order" Text="Place Order" OnClick="btnPlaceOrder_Click1" />
                                </span>
                            </div>
                        </div>
                        <div class="clear"></div>
