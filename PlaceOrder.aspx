<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="PlaceOrder.aspx.cs" Inherits="UserPlaceHolder" %>
                ...
                <div class="cont-desc">
                    <div class="product-details">
                        ...
                        <div class="desc span_3_of_2">
                            ...
                            <div>
                                <span>
                                   <asp:Button class="submitButton" ID="btnPlaceOrder" runat="server" Value="Place Order" Text="Place Order" OnClick="btnPlaceOrder_Click" />
                                </span>
                            </div>
                        </div>
                        <div class="clear"></div>
                    ...
                    <ItemTemplate>
                        <div class="grid_1_of_4 images_1_of_4">
                            ...
                            <div class="price-details">
                                ...
                                <div class="add-cart">
                                    <h4><a href="PlaceOrder.aspx?id=<%#Eval("PlantId") %>">Add to Cart</a></h4>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
