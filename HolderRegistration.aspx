<%@ Page Title="" Language="C#" MasterPageFile="~/homemaster.master" AutoEventWireup="true" CodeFile="HolderRegistration.aspx.cs" Inherits="HolderRegistration" %>
                    ...
                    <div class="section group">
                        ...
                        <div class="section group">
                            ...
                            <div class="col span_1_of_3">
                                ...
                                <span>
                                    <asp:TextBox runat="server" ID="txtPassword" CssClass="bigTextBox"></asp:TextBox>
                            ...
                            <div class="section group">
                                <div class="col span_1_of_3">
                                    ...
                                    <span>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVLocation" runat="server" ErrorMessage="Enter Extension No" ForeColor="Red"
