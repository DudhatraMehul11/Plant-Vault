<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="userpostcomplain.aspx.cs" Inherits="userpostfeedback" %>
                    ...
                    <div class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div>
                                ...
                                <span>
                                    <asp:TextBox ID="txtComplain" ToolTip="Complain" TextMode="MultiLine" Width="495px" class="bigTextBox" runat="server"></asp:TextBox>
                            ...
                            <div>
                                <span>
                                    ...
                                    <asp:Button ID="btnUpdate" runat="server" value="Update" class="updateButton" Text="Update" />

                                    <asp:Button ID="btnDelete" runat="server" value="Delete" class="deleteButton" Text="Delete" />
