...
public partial class manageProfile : System.Web.UI.Page
{
    ...
    //    //cmd.Parameters.AddWithValue("@city_id", .Text);
    //    //cmd.Parameters.AddWithValue("@state_id", txtFirstName.Text);
    //    //cmd.Parameters.AddWithValue("@country_id", txtFirstName.Text);
    //    cmd.ExecuteNonQuery();
    //    con.Close();
    ...
    private void GetById(int id)
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con"].ConnectionString);
        con.Open();
        string query = "select registration_id,first_name,middle_name,last_name,mobile_no,birth_date,gender,address,city_id,state_id,country_id from registration where registration_id = " + id;
    ...
    public void GetCity()
    {
        ...
        SqlCommand cmd = new SqlCommand("select city_id, city_name from city where state_id = '" + ddlState.SelectedValue + "'", con);
        SqlDataAdapter sda = new SqlDataAdapter(cmd);
        DataTable dt = new DataTable();
        sda.Fill(dt);
        con.Close();
